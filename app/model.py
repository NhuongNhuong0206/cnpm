from sqlalchemy import Column, Integer, String, Float, ForeignKey, Enum, Boolean, DateTime, PrimaryKeyConstraint
...
class Flight(BaseModel):
    ...
    # flight_flight_schedules = relationship('Flight_Flight_schedule', backref='flight', lazy=True)
...
class Flight_schedule(BaseModel):
    ...
    # flight_flight_schedules = relationship('Flight_Flight_schedule', backref='flight_schedule', lazy=True)
